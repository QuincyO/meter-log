...
| Day                                   | What shipped                                                       |
| ------------------------------------- | ------------------------------------------------------------------ |
| [2026-07-26](changelog/2026-07-26.md) | Offline road maps, offline geocoding, districts drawn on the planner; graphify wiring; district builds fixed, with a progress bar, and districts you can remove, grow and hold several of |

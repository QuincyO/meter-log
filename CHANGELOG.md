...
| Day                                   | What shipped                                                       |
| ------------------------------------- | ------------------------------------------------------------------ |
| [2026-07-26](changelog/2026-07-26.md) | Offline road maps, offline geocoding, districts drawn on the planner; graphify wiring; district builds fixed, with a progress bar; districts you can remove, grow and hold several of; turn-by-turn off the offline pack, shown on the Drive screen and route view |

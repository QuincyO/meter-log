...
_Exported 2026-08-21 03:52 America/Toronto_

Nightly Markdown snapshot of the meter-log Google Sheet.

- [Stops](Stops.md) — 1197 rows
- [StopsArchive](StopsArchive.md) — 10 rows
- [Downtime](Downtime.md) — 358 rows
- [Tracker](Tracker.md) — 86 rows
- [Employees](Employees.md) — 8 rows
- [Teams](Teams.md) — 1 row
- [Captains](Captains.md) — 5 rows
- [Subs](Subs.md) — 6 rows
- [Timing](Timing.md) — 1279 rows
- [Days](Days.md) — 84 rows

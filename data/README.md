...
_Exported 2026-09-12 03:52 America/Toronto_

Nightly Markdown snapshot of the meter-log Google Sheet.

- [Stops](Stops.md) — 1959 rows
- [StopsArchive](StopsArchive.md) — 17 rows
- [Downtime](Downtime.md) — 484 rows
- [Tracker](Tracker.md) — 116 rows
- [Employees](Employees.md) — 8 rows
- [Teams](Teams.md) — 1 row
- [Captains](Captains.md) — 5 rows
- [Subs](Subs.md) — 6 rows
- [Timing](Timing.md) — 2013 rows
- [Days](Days.md) — 114 rows

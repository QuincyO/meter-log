...
_Exported 2026-08-24 03:52 America/Toronto_

Nightly Markdown snapshot of the meter-log Google Sheet.

- [Stops](Stops.md) — 1244 rows
- [StopsArchive](StopsArchive.md) — 10 rows
- [Downtime](Downtime.md) — 369 rows
- [Tracker](Tracker.md) — 88 rows
- [Employees](Employees.md) — 8 rows
- [Teams](Teams.md) — 1 row
- [Captains](Captains.md) — 5 rows
- [Subs](Subs.md) — 6 rows
- [Timing](Timing.md) — 1328 rows
- [Days](Days.md) — 86 rows

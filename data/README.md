...
_Exported 2026-09-05 03:52 America/Toronto_

Nightly Markdown snapshot of the meter-log Google Sheet.

- [Stops](Stops.md) — 1851 rows
- [StopsArchive](StopsArchive.md) — 16 rows
- [Downtime](Downtime.md) — 458 rows
- [Tracker](Tracker.md) — 111 rows
- [Employees](Employees.md) — 8 rows
- [Teams](Teams.md) — 1 row
- [Captains](Captains.md) — 5 rows
- [Subs](Subs.md) — 6 rows
- [Timing](Timing.md) — 1900 rows
- [Days](Days.md) — 109 rows
